...
class DataObject:
  def __init__(self, name, applications, responses):
    ...
    if name == "Master":
      ...
      self.applications["description"] = self.applications["description"].map(lambda description: re.sub(r"</?(?:p|span)>", "", re.sub("<br>", " ", description)) if type(description) == str else None)
    else:
...
def green_keywords(df): #243 key words/phrases
  green_terms_table = {"climate change adaptation" : r"climate[-\s]resilience|climate[-\s]adaptation|adaptation[-\s]measures|resilience[-\s]measures|future[-\s]proofing|flood[-\s]resilience|flood[-\s]resistance|overheating[-\s]mitigation|thermal[-\s]comfort|sustainable[-\s]drainage|rainwater[-\s]management|surface[-\s]water[-\s]management|water[-\s]efficiency|drought[-\s]resilience|green[-\s]infrastructure|biodiversity[-\s]enhancement|nature[-\s]based[-\s]solutions",
                       ...
                       "policy references" : r"climate[-\s]emergency|net[-\s]zero[-\s]strategy|local[-\s]plan[-\s]climate[-\s]policies|national[-\s]planning[-\s]policy[-\s]framework|nppf|historic[-\s]england[-\s]guidance|pas[-\s]2035[-\s](retrofit)|energy[-\s]performance[-\s]certificate|epc|whole[-\s]house[-\s]plan",
                       "general accessibility" : r"accessibility|improved[-\s]access|inclusive[-\s]access|inclusive[-\s]design|equal[-\s]access|universal[-\s]design|step[-\s]free[-\s]access|accessible[-\s]entrance|improved[-\s]circulation|enhanced[-\s]accessibility|improved[-\s]usability|accessible[-\s]route|barrier[-\s]free[-\s]access|ease[-\s]of[-\s]access|access[-\s]improvements",
                       "physical alterations" : r"ramp|access[-\s]ramp|platform[-\s]lift|passenger[-\s]lift|wheelchair[-\s]lift|stair[-\s]lift|new[-\s]lift[-\s]shaft|level[-\s]threshold|dropped[-\s]kerb|handrails|guardrails|new[-\s]steps|wider[-\s]doorway|automatic[-\s]doors|power[-\s]assisted[-\s]doors|entrance[-\s]alterations|new[-\s]entrance|accessible[-\s]wc|changing[-\s]places[-\s]toilet|internal[-\s]reconfiguration|wayfinding|signage|tactile[-\s]paving|tactile[-\s]signage|hearing[-\s]loop|automatic[-\s]opening[-\s]system",
                       "disability and inclusion" : r"disabled[-\s]access|wheelchair[-\s]access|mobility[-\s]impaired|people[-\s]with[-\s]disabilities|inclusive[-\s]environment|accessibility[-\s]for[-\s]all|independent[-\s]access|equal[-\s]opportunities|dementia[-\s]friendly|neurodiverse[-\s]users|visual[-\s]impairment|hearing[-\s]impairment",
                       "legislation and guidance" : r"equality[-\s]act[-\s]2010|approved[-\s]document[-\s]m|building[-\s]regulations[-\s]part[-\s]m|bs[-\s]8300|inclusive[-\s]design[-\s]guidance|historic[-\s]england[-\s]guidance[-\s]on[-\s]improving[-\s]access|access[-\s]statement|design[-\s]and[-\s]access[-\s]statement",
                       "heritage language" : r"sensitive[-\s]intervention|minimal[-\s]intervention|reversible[-\s]works|heritage[-\s]significance|conservation[-\s]led[-\s]design|historic[-\s]fabric|less[-\s]than[-\s]substantial[-\s]harm|public[-\s]benefit|balanced[-\s]approach|proportionate[-\s]response",
                       "home improvement and quality of life" : r"improved[-\s]living[-\s]accommodation|enhanced[-\s]living[-\s]conditions|improved[-\s]quality[-\s]of[-\s]life|better[-\s]use[-\s]of[-\s]space|modernisation|improved[-\s]functionality|contemporary[-\s]living|flexible[-\s]living|family[-\s]living|open[-\s]plan[-\s]living|adaptation[-\s]to[-\s]modern[-\s]living|better[-\s]circulation|improved[-\s]layout|rationalised[-\s]layout|increased[-\s]comfort|enhanced[-\s]amenity|increased[-\s]enjoyment[-\s]of[-\s]the[-\s]property",
                       "growing or changing families" : r"family[-\s]needs|growing[-\s]family|additional[-\s]accommodation|extra[-\s]bedroom|home[-\s]office|study|playroom|multi[-\s]functional[-\s]space|flexible[-\s]accommodation|multi[-\s]generational[-\s]living|independent[-\s]living|annex|adaptable[-\s]accommodation|lifetime[-\s]home",
                       "health and wellbeing" : r"wellbeing|health[-\s]and[-\s]wellbeing|improved[-\s]natural[-\s]light|daylighting|ventilation|improved[-\s]ventilation|better[-\s]outlook|garden[-\s]access|outdoor[-\s]living|private[-\s]amenity[-\s]space|connection[-\s]to[-\s]the[-\s]garden|improved[-\s]comfort|reduced[-\s]overheating|quiet[-\s]enjoyment",
                       "ageing and future needs" : r"future[-\s]proofing|lifetime[-\s]living|ageing[-\s]in[-\s]place|accessible[-\s]accommodation|adaptable[-\s]home|single[-\s]storey[-\s]living|ground[-\s]floor[-\s]bedroom|ground[-\s]floor[-\s]bathroom|mobility[-\s]needs",
                       "leisure and lifestyle" : r"garden[-\s]room|conservatory|orangery|outdoor[-\s]entertaining|home[-\s]gym|hobby[-\s]room|cinema[-\s]room|recreation|lifestyle[-\s]enhancement",
                       "working from home" : r"home[-\s]office|remote[-\s]working|hybrid[-\s]working|dedicated[-\s]workspace|workspace|home[-\s]working|flexible[-\s]workspace",
                       "energy and comfort" : r"improved[-\s]thermal[-\s]comfort|energy[-\s]efficiency|reduced[-\s]energy[-\s]bills|increased[-\s]comfort|improved[-\s]indoor[-\s]environment|sustainable[-\s]living"}

  df["green_keywords"] = [[category for category, pattern in green_terms_table.items() if type(text) == str and re.search(pattern, text, flags = re.IGNORECASE)] for text in df["description"]]
